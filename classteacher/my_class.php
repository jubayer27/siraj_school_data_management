...
// We assume header.php contains the HTML skeleton (<html>, <head>...)
// If you don't have a header file, ensure you add the HTML DOCTYPE and Bootstrap links manually.
...
if (!$my_class)
    die("<div class='alert alert-danger m-5'>You are not assigned to any class yet. Please contact the Administrator.</div>");
...
<?php include 'includes/sidebar.php'; // Ensure your sidebar code is saved in this file ?>
    ...
    <div class="container-fluid">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <div class="d-flex align-items-center gap-3">
                <span class="text-muted small"><i class="fas fa-users me-1"></i> <?php echo $my_students->num_rows; ?>
                    Students</span>
            </div>
        </div>
        ...
        <div class="row g-3 mb-4">
            <div class="col-md-3">
                <a href="my_class_students.php" class="nav-card">
                    <div>
                        <h6 class="fw-bold m-0">Student List</h6>
                        <span class="small text-muted">View full profiles</span>
                    </div>
            ...
            <div class="col-md-3">
                <a href="my_subject_teachers.php" class="nav-card">
                    <div>
                        <h6 class="fw-bold m-0">Subject Teachers</h6>
                        <span class="small text-muted">Manage instructors</span>
                    </div>
            ...
            <div class="col-md-3">
                <a href="assign_subjects.php" class="nav-card">
                    <div>
                        <h6 class="fw-bold m-0">Enrollments</h6>
                        <span class="small text-muted">Assign subjects</span>
                    </div>
            ...
            <div class="col-md-3">
                <a href="class_performance.php" class="nav-card">
                    <div>
                        <h6 class="fw-bold m-0">Performance</h6>
                        <span class="small text-muted">Class analytics</span>
                    </div>
                                    ...
                                    <li class="list-group-item">
                                        ...
                                        <div class="d-flex gap-2 mt-2">
                                            <a href="my_class.php?approve_id=<?php echo $inc['transfer_id']; ?>"
                                                class="btn btn-sm btn-success flex-fill"><i class="fas fa-check"></i> Accept</a>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title fw-bold"><i class="fas fa-exchange-alt me-2 text-warning"></i> Transfer Students
                </h5>
