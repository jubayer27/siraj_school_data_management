    ...
    <ul class="menu">
        ...
        <li>
            <a href="my_class.php" class="<?php echo $current_page == 'my_class.php' ? 'active' : ''; ?>">
                <i class="fas fa-chalkboard-user"></i> <span>Class Details</span>
            </a>
        </li>
        ...
        <li>
            <a href="class_performance.php"
                ...
                <i class="fas fa-chart-line"></i> <span>Class Performance</span>
            </a>
        </li>
...
<script>
    ...
    function setTheme(themeName) {
        ...
        localStorage.setItem('classTheme', themeName);
    }

    (function () {
        const savedTheme = localStorage.getItem('classTheme');
        if (savedTheme) {
            setTheme(savedTheme);
        }
    })();
