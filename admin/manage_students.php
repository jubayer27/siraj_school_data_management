...
if (isset($_GET['delete_id'])) {
    ...
    if ($img && $img['photo'] && file_exists("../uploads/" . $img['photo'])) {
        unlink("../uploads/" . $img['photo']);
    }

    $conn->query("DELETE FROM students WHERE student_id = $did");
    // Also delete from enrollment tables (Cascading usually handles this in DB, but safety first)
...
$sql .= " ORDER BY s.student_id DESC LIMIT 100"; // Added Limit for performance
        ...
        <div class="container-fluid">
                ...
                <div class="col-md-4">
                    <div class="stat-card">
                        ...
                        <div>
                            ...
                            <span class="text-muted small text-uppercase">Total Enrollment</span>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="stat-card">
                        <div class="stat-icon bg-primary bg-opacity-10 text-primary"><i class="fas fa-male"></i></div>
                        <div>
                            <h3 class="fw-bold mb-0"><?php echo $boys; ?></h3>
                            <span class="text-muted small text-uppercase">Boys</span>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="stat-card">
                        <div class="stat-icon bg-danger bg-opacity-10 text-danger"><i class="fas fa-female"></i></div>
                        <div>
                            <h3 class="fw-bold mb-0"><?php echo $girls; ?></h3>
                            <span class="text-muted small text-uppercase">Girls</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card border-0 shadow-sm mb-4" id="addStudentForm" style="display:none;">
                <div class="card-body p-4">
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        <h5 class="fw-bold text-dark m-0"><i class="fas fa-user-plus text-warning me-2"></i> Quick
                            Registration</h5>
                    ...
                    <form method="POST" enctype="multipart/form-data" autocomplete="off">
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="school_register_no" class="form-control"
                                    placeholder="e.g. S-2025-001" required>
                            </div>
                            <div class="col-md-4">
                            ...
                            <div class="col-12">
                                <label class="form-label small fw-bold text-muted">Student Photo (Optional)</label>
                        ...
                        <div class="d-flex justify-content-end mt-4">
                            ...
                            <button type="submit" name="add_student"
                                class="btn btn-warning fw-bold text-dark px-4">Create Profile</button>
                        </div>
                    </form>
                </div>
            </div>
                        ...
                        <div class="col-md-6">
                            <div class="input-group">
                                ...
                                <input type="text" name="search" class="form-control"
                                    placeholder="Search by Name, ID or IC..." value="<?php echo $search; ?>">
                            </div>
                        </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover align-middle mb-0">
                            ...
                            <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="font-monospace text-dark small fw-bold">
                                                    <?php echo $row['school_register_no']; ?>
                                                </div>
                                            ...
                                            <td class="text-end pe-4">
                                                ...
                                                <a href="edit_student.php?student_id=<?php echo $row['student_id']; ?>"
                                                    class="btn btn-sm btn-warning text-dark me-1" title="Edit"><i
                                                        class="fas fa-edit"></i></a>
                                                <a href="manage_students.php?delete_id=<?php echo $row['student_id']; ?>"
                                                    class="btn btn-sm btn-danger" title="Delete"
                                                    onclick="return confirm('Delete this student? This will also remove their marks and enrollment history.');"><i
                                ...
                                <?php else: ?>
                                    <tr>
                                        <td colspan="5" class="text-center py-5 text-muted">No students found matching your
                                            criteria.</td>
                                    </tr>
                                <?php endif; ?>
                            </tbody>
